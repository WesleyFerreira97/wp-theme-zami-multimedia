...
class All_in_widget_base_header extends Widget_Base {
        ...
        <header class="component-info">
            <div class="component-info__wrap">
                <div class="component-info__bar">
                    <h3 class="component-info__tag">Movies</h3>
                    <h3 class="component-info__author">Wesley Ferreira</h3>
                </div>
                <h1 class="component-info__title">Loki’s season finale villain is a complete story-killer</h1>
                ...
                <div class="component-info__bar">
                    ...
                    <h3 class="component-info__date">14/07/2021</h3>                    
                </div>
            </div>
        </header>
